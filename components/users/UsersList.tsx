...
import { Edit2, Trash2, Avatar as AvatarIcon } from 'lucide-react'
...
export function UsersList({ users, onEdit, onDelete, isLoading }: UsersListProps) {
  if (isLoading) {
    return (
        ...
        <tbody className="divide-y divide-gray-200">
          {users.map((user) => (
            <tr key={user.id} className="hover:bg-gray-50 transition-colors">
              ...
              <td className="px-6 py-3 text-gray-600 font-mono text-xs">{user.phone}</td>
              <td className="px-6 py-3">
